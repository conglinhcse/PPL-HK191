...
class MCVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by MCParser#arr_one.
    def visitArr_one(self, ctx:MCParser.Arr_oneContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by MCParser#para_decl_many.
    def visitPara_decl_many(self, ctx:MCParser.Para_decl_manyContext):
        return self.visitChildren(ctx)
