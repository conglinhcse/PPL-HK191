...
#2.4 Type Mismatch In Expression:
    def test_mismatch_array_id (self):
        ...
        """
        expect= "Uninitialized Variable: _int_a"
...
#     def test_uninitialized_variable_in_if (self):
#         input="""
#         int main(){
#             int k;
#             if (true) k=5;
...
#     def test_uninitialized_variable_in_block (self):
#         input="""
#         void main() {
#             int a,b;
#             for (1;true;2){
...
#                 break;
#             }
#             b=a; // ->> raise uninitialized variable
